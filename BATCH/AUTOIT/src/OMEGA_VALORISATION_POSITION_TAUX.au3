...
;==================================================================================================
Local $sFilePath1 = $SavePath1 & "Base_Oblig_"&$sdate&".xls" 
...
ConsoleWrite("Valorisation Finie:"&$group&" a la date "&$sEngagDate&@CRLF)
;==================================================================================================
Local $sFilePath2 = $SavePath2 & "Base_Oblig_"&$sdate&".xls" 
ConsoleWrite("Export Detail dans "&$sFilePath1&@CRLF)
...
;*********************************************FIN********************************************************************
;~ Copie du fichier Mandats dans un repertoire metier
FileCopy ( $sFilePath1, "\\vill1\partage\,FGA Front Office\04_Gestion_Taux\01_Gestion\01_Mandats\SYNTHESE\BASE OBLIG MANDAT.xls" ,1 )
